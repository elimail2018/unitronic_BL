...
namespace ParkingSystem
{
    ...
    /// </summary>
    internal class ValueTicket : Ticket
    {
        ...
        public ValueTicket(int? timeLimit, int cost, Dimensions dimensions, string lots, List<VehicleClassType> VehicleClassTypes)
        {
            _ticketType = "value";
        ...
        {
            return this._parkingSpots.Find(p => p.IsAvailable && p.SpotLocation >= 1 && p.SpotLocation <= 11);
